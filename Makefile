.PHONY: build-php73-cli-alpine build-php73-fpm-alpine build-php72-cli-alpine build-php72-fpm-alpine

default: build-php73-cli-alpine build-php73-fpm-alpine build-php72-cli-alpine build-php72-fpm-alpine
